export const SITE = {
  ...
  shortName: "룰루랄라 나이트",
  // 2026-09-13 창원룰루랄라나이트 광고 해지(비광고주) — 닉네임·전화 필드를 지웠다. 어느 쪽에도 연락처를 싣지 않는다.
  url: "https://g.nolcool.com",
  domain: "g.nolcool.com",
  city: "창원시",
  district: "성산구",
  region: "경상남도",
  country: "대한민국",
...
export const SITE_OTHER = {
  ...
  "twitter:label1": "입장 연령",
  "twitter:data1": "27세 이상",
} as const;
...
export const SITE_OTHER_NOPHONE = (() => {
  return { ...SITE_OTHER };   /* 2026-09-14 — SITE_OTHER 에서 전화 칸을 뺐으므로 같은 값 */
})();
...
> = {
  "/": {
    ...
    description:
      "창원에서 성공하는 사람들의 공통점을 상남동에서 본 그대로 적었습니다. 평판·도시의 시간·기억·술자리·돈 쓰는 방식·잔존율 여섯 가지와 오늘 할 수 체크리스트.",
  ...
  "/lotto": {
    title: "창원룰루랄라나이트 담당 안내 — 연락처 미게재",
    description:
      "창원룰루랄라나이트는 이 사이트와 제휴 관계가 없어 담당자 연락처를 싣지 않습니다. 자리와 가격은 방문 당일 현장에서 확인하세요.",
    hook: "담당자 연락처는 싣지 않습니다. 현장에서 직접 확인하세요.",
    capsule:
      "창원 룰루랄라 나이트는 이 사이트와 제휴 관계가 없어 담당자 연락처를 안내하지 않습니다.",
  },
  "/price": {
    title: "창원룰루랄라나이트 가격 — 도착 후 '몰랐던 추가요금' 0원",
    description:
      "창원룰루랄라나이트 가격은 인원·옵션·시간대에 따라 다릅니다. 이 사이트는 업소와 제휴 관계가 없어 금액을 대신 안내하지 않습니다.",
    hook: "정확한 금액은 방문 당일 현장에서 확인하는 것이 가장 확실합니다.",
    capsule:
      "창원 룰루랄라 나이트 가격은 인원·옵션·시간대에 따라 다르며, 정확한 금액은 현장에서 확인해야 합니다.",
  },
  "/location": {
    title: "창원룰루랄라나이트 오시는 길 — 상남동 22-4 지하 3층",
    description:
      "창원룰루랄라나이트 위치는 창원시 성산구 상남동 22-4 지하 3층(모아엔트몰), 도로명 마디미로43번길 10. 모아엔트몰 건물 안 지하 3층입니다.",
    hook: "처음이라 위치가 헷갈리면 모아엔트몰 건물부터 찾으세요.",
    capsule:
      "창원 룰루랄라 나이트는 경상남도 창원시 성산구 상남동 22-4 지하 3층, 도로명 마디미로43번길 10에 있습니다.",
  },
  "/reserve": {
  ...
  "/photo": {
    title: "창원룰루랄라나이트 홀 구역 안내 — 입구부터 자리까지",
    description:
      "창원룰루랄라나이트의 입구·룸·테이블·바·VIP 자리가 어떻게 나뉘는지 손님 동선 순으로 적었습니다. 확인되지 않은 것은 적지 않습니다.",
    hook: "확인된 것만 글로 적습니다. 다른 가게 그림 갖다 쓰지 않습니다.",
    capsule:
      "창원 룰루랄라 나이트의 입구·룸·테이블·바·VIP 자리가 어떻게 나뉘는지 손님 동선 순으로 글로 적었습니다. 이 쪽에는 그림을 올리지 않습니다.",
  },
  "/news": {
  ...
  "/contact": {
    title: "창원룰루랄라나이트 문의 안내 — 업소와 제휴 관계 없음",
    description:
      "창원룰루랄라나이트는 이 사이트와 제휴 관계가 없어 문의를 대신 받지 않습니다. 예약·가격·길 안내는 현장에서 확인하세요.",
    hook: "이 사이트는 업소 문의를 대신 받지 않습니다.",
    capsule:
      "창원 룰루랄라 나이트 문의는 이 사이트가 대신 받지 않습니다(업소와 제휴 관계 없음).",
  },
};

...
> = {
  "/": {
    title: "창원 룰루랄라 나이트 — 짱구가 직접 받습니다 010-3854-6887",
    description:
      "창원 룰루랄라 나이트 공식. 매니저 짱구가 010-3854-6887로 직접 받습니다. 직원 콜백 없이 30초 한 통화로 자리 확정. 창원시 성산구 상남동 22-4 지하 3층, 19세 이상 합법 영업장.",
  ...
  "/jjanggu": {
    ...
    description:
      "010-3854-6887. 직원 콜백 없음, 메모 후 대기 없음. 매니저 짱구가 가격·자리·시간을 한 통화에 정해드립니다. 처음 거시는 분 더 환영합니다.",
  ...
  "/location": {
    ...
    description:
      "창원시 성산구 상남동 22-4 지하 3층(모아엔트몰), 도로명 마디미로43번길 10. 처음이라 헤매시면 도착 직전 010-3854-6887 한 통 — 짱구가 입구까지 잡아드립니다.",
  ...
  "/reserve": {
    ...
    description:
      "전화 한 번이면 끝납니다. ‘짱구 매니저요’ 한마디 → 인원·날짜·시간 → 자리 확정. 010-3854-6887. 처음 거시는 분도 30초면 끝납니다. 진짜로.",
  ...
  "/news": {
    ...
    description:
      "임시 휴무·영업시간 변경·입구/주차 변동을 사이트에 가장 먼저 게시. 출발 전 30초 확인이면 헛걸음 안 합니다. 더 정확한 답은 010-3854-6887로 짱구에게.",
  ...
  "/contact": {
    title: "문의 — 전화가 문자보다 열 배 빠릅니다 010-3854-6887",
    description:

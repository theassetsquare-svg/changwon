...
> = {
  "/": {
    title: "창원에서 성공하는 방법 — 상남동 밤에서 본 여섯 가지 | 창원룰루랄라나이트",
    description:
      "창원에서 성공하는 사람들의 공통점을 상남동 지하 3층 홀에서 본 그대로 적었습니다. 평판·시간·기억·술자리·돈·잔존율 여섯 가지. 창원룰루랄라나이트 공식 사이트, 예약 문의 010-3854-6887.",
    hook: "창원에서 잘되는 사람은 처음부터 티가 납니다. 다만 이유가 다릅니다.",
    capsule:
      "창원에서 성공하는 방법으로 이 페이지가 정리한 것은 평판·도시의 시간·기억·술자리·돈 쓰는 방식·오래 남는 힘 여섯 가지이며, 이는 창원시 성산구 상남동 22-4 지하 3층에서 영업하는 창원 룰루랄라 나이트의 매니저가 현장에서 관찰한 내용입니다. 매장은 27세 이상 출입 가능한 합법 영업장이고 예약 문의는 전화 010-3854-6887입니다.",
  },
  "/about": {
  ...
  "/jjanggu": {
    title: "창원룰루랄라나이트 매니저 소개 — 직접 응대 010-3854-6887",
    description:
  ...
  "/price": {
    ...
    capsule:
      "창원 룰루랄라 나이트 가격은 인원·옵션·시간대에 따라 다르며, 전화 010-3854-6887로 정확한 금액을 안내합니다.",
  },
  "/location": {
    title: "창원룰루랄라나이트 오시는 길 — 상남동 22-4 지하 3층",
    description:
      "창원룰루랄라나이트 위치는 창원시 성산구 상남동 22-4 지하 3층(모아엔트몰), 도로명 마디미로43번길 10. 헤매시면 010-3854-6887로 전화 주세요.",
  ...
  "/contact": {
    title: "창원룰루랄라나이트 문의 — 매니저 직접 응대 010-3854-6887",
    description:
      "창원룰루랄라나이트 문의는 매니저가 직접 응대. 예약·가격·길 안내·VIP 룸까지 한 번에 답 드립니다. 010-3854-6887.",
    hook: "편하게 문의하세요.",
    capsule:

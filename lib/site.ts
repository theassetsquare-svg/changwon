export const SITE = {
  ...
  country: "대한민국",
  description:
    "창원 룰루랄라 나이트 공식 사이트. 창원시 성산구 상남동 22-4 지하 3층, 19세 이상 합법 영업장. 카카오톡 besta12로 문의·예약.",
  shortDescription:
    "창원 룰루랄라 나이트. 상남동 22-4 지하 3층, 19세 이상 합법 영업장. 카카오톡 besta12.",
  keywords: [
    "창원 룰루랄라 나이트",
    "창원룰루랄라나이트",
    "창원 룰루랄라",
...
> = {
  "/": {
    title: "창원 룰루랄라 나이트 — 카카오톡 besta12 문의",
    description:
      "창원 룰루랄라 나이트 공식. 카카오톡 besta12로 직접 문의하세요. 30초 안에 자리 확정. 창원시 성산구 상남동 22-4 지하 3층, 19세 이상 합법 영업장.",
    hook: "처음이라 어색해도 괜찮습니다. 카카오톡 한 통이면 끝납니다.",
    capsule:
      "창원 룰루랄라 나이트는 창원시 성산구 상남동 22-4 지하 3층의 19세 이상 합법 영업장이며, 카카오톡 besta12로 예약을 안내합니다.",
  },
  "/about": {
  ...
  "/jjanggu": {
    title: "매니저 소개 — 카카오톡 besta12",
    description:
      "카카오톡 besta12로 직접 문의하세요. 매니저가 가격·자리·시간을 한 번에 안내합니다. 처음 오시는 분 더 환영합니다.",
    hook: "잘 모르는 매장에 처음 연락하기 부담되시죠? 카카오톡으로 편하게 물어보세요.",
    capsule:
      "창원 룰루랄라 나이트 매니저는 카카오톡 besta12로 직접 응대하며 손님에게 맞는 자리와 가격을 안내합니다.",
  },
  "/price": {
    ...
    capsule:
      "창원 룰루랄라 나이트 가격은 인원·옵션·시간대에 따라 다르며, 카카오톡 besta12로 정확한 금액을 안내합니다.",
  },
  "/location": {
    title: "오시는 길 — 상남동 22-4 지하 3층 · 입구까지 잡아드립니다",
    description:
      "창원시 성산구 상남동 22-4 지하 3층(모아엔트몰), 도로명 마디미로43번길 10. 처음이라 헤매시면 카카오톡 besta12로 연락 주세요.",
  ...
  "/reserve": {
    ...
    description:
      "카카오톡 한 번이면 끝납니다. besta12 → 인원·날짜·시간 → 자리 확정. 처음 오시는 분도 30초면 끝납니다. 진짜로.",
    hook: "예약은 진짜 카카오톡 한 번입니다. 어렵게 생각하지 마세요.",
    capsule:
      "창원 룰루랄라 나이트 예약은 카카오톡 besta12로 인원·날짜·시간을 보내면 한 번에 자리가 확정됩니다.",
  },
  "/review": {
  ...
  "/news": {
    ...
    description:
      "임시 휴무·영업시간 변경·입구/주차 변동을 사이트에 가장 먼저 게시. 출발 전 30초 확인이면 헛걸음 안 합니다. 더 정확한 답은 카카오톡 besta12로.",
  ...
  "/contact": {
    title: "문의 — 카카오톡 besta12",
    description:
      "매니저가 직접 응대. 카카오톡 besta12로 문의하시면 예약·가격·길 안내·VIP 룸 — 한 번에 다 답 나옵니다.",
    hook: "카카오톡 besta12로 편하게 문의하세요.",
    capsule:
      "창원 룰루랄라 나이트 문의는 카카오톡 besta12로 하시면 매니저가 직접 응대합니다.",
  },
};

export const SITE = {
  ...
  country: "대한민국",
  description:
    "창원 룰루랄라 나이트 공식 사이트. 매니저 짱구가 직접 전화 받습니다. . 창원시 성산구 상남동 22-4 지하 3층, 19세 이상 합법 영업장. 통화 한 번이면 자리 잡힙니다.",
  shortDescription:
    "창원 룰루랄라 나이트 짱구 . 상남동 22-4 지하 3층, 직통 예약, 19세 이상 합법 영업장.",
  keywords: [
    "창원 룰루랄라 나이트",
    "창원룰루랄라나이트",
    "창원 룰루랄라",
...
> = {
  "/": {
    title: "창원 룰루랄라 나이트 — 짱구가 직접 받습니다 ",
    description:
      "창원 룰루랄라 나이트 공식. 매니저 짱구가 로 직접 받습니다. 직원 콜백 없이 30초 한 통화로 자리 확정. 창원시 성산구 상남동 22-4 지하 3층, 19세 이상 합법 영업장.",
    hook: "처음이라 어색해도 괜찮습니다. 전화 한 통이면 끝납니다.",
    capsule:
      "창원 룰루랄라 나이트는 창원시 성산구 상남동 22-4 지하 3층의 19세 이상 합법 영업장이며, 매니저 짱구가 로 직접 전화를 받아 예약을 안내합니다.",
  },
  "/about": {
    title: "어떤 가게냐고요? — 창원 룰루랄라 나이트 매니저 짱구가 답합니다",
    description:
      "사업자 등록 보유 합법 나이트 클럽, 19세 이상 신분증 확인 매장. 짱구가 사람 보고 자리 잡는 곳. 처음 오시는 분은 부담 적은 자리, 단체는 한 자리에 모이게.",
  ...
  "/jjanggu": {
    title: "매니저 짱구 — 전화 받는 사람이 자리 잡는 사람입니다",
    description:
      ". 직원 콜백 없음, 메모 후 대기 없음. 매니저 짱구가 가격·자리·시간을 한 통화에 정해드립니다. 처음 거시는 분 더 환영합니다.",
    hook: "잘 모르는 매장에 처음 전화하기 부담되시죠? 그래서 제가 직접 받습니다.",
    capsule:
      "짱구는 창원 룰루랄라 나이트 매니저로,  번호를 직접 받으며 손님에게 맞는 자리와 가격을 그 자리에서 안내합니다.",
  },
  "/price": {
    title: "가격 솔직 공개 — 도착 후 ‘몰랐던 추가요금’ 0원",
    description:
      "인원·옵션·시간대에 따라 다릅니다. 짱구가 전화 한 통에 정확한 금액을 묶어 안내. 부풀리지 않고, 흥정 없이, 도착 후 추가 요금 0원.",
    hook: "가격은 매번 정확히 말씀드립니다. 전화로 물어보는 게 가장 빨라요.",
    capsule:
      "창원 룰루랄라 나이트 가격은 인원·옵션·시간대에 따라 다르며, 매니저 짱구가 로 그 자리에서 정확한 금액을 묶어 안내합니다.",
  },
  "/location": {
    title: "오시는 길 — 상남동 22-4 지하 3층 · 입구까지 잡아드립니다",
    description:
      "창원시 성산구 상남동 22-4 지하 3층(모아엔트몰), 도로명 마디미로43번길 10. 처음이라 헤매시면 도착 직전  한 통 — 짱구가 입구까지 잡아드립니다.",
  ...
  "/reserve": {
    ...
    description:
      "전화 한 번이면 끝납니다. ‘짱구 매니저요’ 한마디 → 인원·날짜·시간 → 자리 확정. . 처음 거시는 분도 30초면 끝납니다. 진짜로.",
    hook: "예약은 진짜 통화 한 번입니다. 어렵게 생각하지 마세요.",
    capsule:
      "창원 룰루랄라 나이트 예약은 로 전화해 짱구 매니저에게 인원·날짜·시간을 말하면 통화 한 번에 자리가 확정됩니다.",
  },
  "/review": {
  ...
  "/photo": {
    ...
    description:
      "전부 우리 가게 진짜 사진. 짱구가 직접 찍거나 손님이 허락하고 찍어준 컷만. 다른 가게 사진 가져다 쓰지 않습니다. ‘사진이랑 다르네’ 소리 안 나는 매장.",
  ...
  "/news": {
    ...
    description:
      "임시 휴무·영업시간 변경·입구/주차 변동을 사이트에 가장 먼저 게시. 출발 전 30초 확인이면 헛걸음 안 합니다. 더 정확한 답은 로 짱구에게.",
    hook: "가실 때 헛걸음하지 마시라고, 여기 먼저 적어둡니다.",
    capsule:
      "창원 룰루랄라 나이트 소식 페이지는 임시 휴무·영업시간 변경·이벤트 공지를 매장 측에서 직접 사전에 안내하는 자리입니다.",
  },
  "/faq": {
    title: "자주 묻는 질문 — 전화 걸기 전 30초면 끝",
    description:
      "예약·가격·위치·연령·결제·주차·드레스코드까지. 짱구가 전화로 매일 받는 질문 그대로, 광고 문장 빼고 솔직하게 정리. 전화하기 전 한 번 훑으면 통화가 더 빠릅니다.",
  ...
  "/vip": {
    title: "VIP 룸 — 사람 보고 자리 잡는, 짱구가 직접 배정",
    description:
      "VIP 룸은 인원·분위기·일행 구성 보고 짱구가 직접 배정. 별도 동선 가능 여부, 룸 컨디션, 가용 시간대는 통화 한 번에 정확히. 운영 시점 기준 솔직 안내.",
    hook: "VIP 자리는 사람 봐서 잡아드립니다. 일단 전화 주세요.",
    capsule:
      "창원 룰루랄라 나이트 VIP 룸은 실제 운영 시점에만 안내하며, 자리 배정은 매니저 짱구가 인원과 상황을 보고 직접 결정합니다.",
  },
  "/contact": {
    title: "문의 — 전화가 문자보다 열 배 빠릅니다 ",
    description:
      "매니저 짱구가 직접 응대. 문자·카톡·DM보다 전화 한 통이 가장 빠르고 정확합니다. 예약·가격·길 안내·VIP 룸 — 한 통화에 다 답 나옵니다.",
    hook: "문자보다 전화가 열 배 빠릅니다.",
    capsule:
      "창원 룰루랄라 나이트 문의는 로 전화하면 매니저 짱구가 직접 받으며, 문자나 SNS보다 전화가 가장 빠른 답을 받는 방법입니다.",
  },
};

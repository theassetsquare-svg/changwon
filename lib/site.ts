...
> = {
  "/": {
    ...
    description:
      "창원 룰루랄라 나이트 공식. 창원시 성산구 상남동 22-4 지하 3층, 27세 이상 출입 가능한 합법 영업장.",
  ...
  "/about": {
    ...
    description:
      "사업자 등록 보유 합법 나이트 클럽, 27세 이상 출입 가능·신분증 확인 매장. 매니저가 사람 보고 자리 잡는 곳. 처음 오시는 분은 부담 적은 자리, 단체는 한 자리에 모이게.",
  ...
  "/price": {
    ...
    description:
      "인원·옵션·시간대에 따라 다릅니다. 전화 한 통에 정확한 금액을 묶어 안내. 부풀리지 않고, 흥정 없이, 도착 후 추가 요금 0원.",
  ...
  "/location": {
    ...
    description:
      "창원시 성산구 상남동 22-4 지하 3층(모아엔트몰), 도로명 마디미로43번길 10. 처음이라 헤매시면 010-3854-6887로 전화 주세요.",
  ...
  "/faq": {
    ...
    description:
      "예약·가격·위치·연령·결제·주차·드레스코드까지. 매니저가 매일 받는 질문 그대로, 광고 문장 빼고 솔직하게 정리. 전화하기 전 한 번 훑으면 더 빠릅니다.",
  ...
  "/vip": {
    ...
    description:
      "VIP 룸은 인원·분위기·일행 구성 보고 매니저가 직접 배정. 별도 동선 가능 여부, 룸 컨디션, 가용 시간대는 전화 한 번에 정확히. 운영 시점 기준 솔직 안내.",

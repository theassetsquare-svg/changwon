...
//   (창원룰루랄라 = 2026-09-13 광고 해지 · 연락처 싣지 않음)
...
const TABLE_NOTES = [
  ...
  "확인이 끝난 값만 넣었습니다. 없는 항목은 아직 못 찾은 것입니다.",
  "맞춰 본 값만 표에 담았습니다. 빠진 것은 확인 전입니다.",
  "근거가 있는 값만 올렸습니다. 나머지는 아직 모릅니다.",
  "확인된 항목으로만 표를 채웠습니다. 빈칸은 미확인입니다.",
  "대조가 된 것만 실었습니다. 없는 값은 확인하지 못했습니다.",
  "찾아 맞춘 값만 넣었습니다. 빠진 항목은 확인 중입니다.",
  "확인 가능한 것만 표에 두었습니다. 그 밖은 아직입니다.",
  "근거를 확인한 항목만 담았습니다. 빈 곳은 미확인입니다.",
];

...
const 주소틀 = ["주소는 {A} 입니다. 처음 찾아가시는 분은 이 주소를 지도에 그대로 넣으시면 됩니다.", "찾아가실 곳은 {A} 입니다. 지도 앱에 이 주소를 그대로 넣으시면 헤매지 않습니다.", "위치는 {A} 로 확인됩니다. 출발 전에 이 주소를 지도에 옮겨 두시면 편합니다.", "{A} 에 있습니다. 주소를 그대로 검색하시면 바로 나옵니다.", "자리는 {A} 입니다. 이 주소만 알고 계시면 길 찾는 데 어려움은 없습니다.", "확인된 주소는 {A} 입니다. 지도에 넣어 두고 출발하시는 편이 낫습니다.",
    "장소는 {A} 입니다. 지도에 이대로 옮겨 두시면 길이 단순해집니다.",
    "{A} 가 확인된 주소입니다. 출발하시기 전에 저장해 두십시오.",
    "찾으실 자리는 {A} 입니다. 주소만 있으면 어렵지 않습니다.",
    "{A} 로 오시면 됩니다. 건물 앞까지는 지도가 안내합니다.",
    "주소를 그대로 옮기면 {A} 입니다. 검색창에 넣어 보십시오.",
    "자리한 곳은 {A} 입니다. 미리 저장해 두시면 당일이 편합니다.",
    "{A} 에 자리합니다. 지도 앱이 건물까지 데려다줍니다.",
    "확인된 자리는 {A} 입니다. 길이 헷갈리면 이 주소를 보여 주십시오.",
    "오실 곳은 {A} 입니다. 택시라면 이 주소를 그대로 말씀하시면 됩니다.",
    "{A} 입니다. 이 한 줄이면 찾아오시는 데 충분합니다.",
    "위치를 적으면 {A} 입니다. 출발 전에 한 번 눈에 담아 두십시오.",
    "주소는 {A} 로 나옵니다. 그대로 넣으시면 바로 잡힙니다.",
    "{A} 에서 만나시면 됩니다. 주소는 이것 하나입니다.",
    "기록된 주소는 {A} 입니다. 지도에 넣어 두고 움직이십시오."];
const 역틀 = [" 가까운 역은 {S} 이고, 역에서 나와 걷는 길이 복잡하지 않습니다.", " 가장 가까운 역은 {S} 입니다.", " 역으로는 {S} 이 가깝습니다.", " {S} 에서 걸어오실 수 있습니다.", " 대중교통으로는 {S} 이 가장 가깝습니다.", " 가까운 역은 {S} 입니다. 걷는 거리가 부담스럽지 않습니다.",
    " 가까운 역은 {S} 이라 대중교통이 편합니다.",
    " 역은 {S} 이 가장 가깝습니다.",
    " {S} 에서 오시면 됩니다.",
    " 근처 역으로는 {S} 이 있습니다.",
    " 지하철이면 {S} 이 가깝습니다.",
    " {S} 이 가장 가까운 역입니다.",
    " 대중교통은 {S} 을 기준으로 잡으시면 됩니다.",
    " 역에서 오신다면 {S} 입니다.",
    " {S} 에서 걸어오시는 분이 많습니다.",
    " 가까운 역 {S} 을 기준으로 움직이시면 편합니다.",
    " 오실 때 {S} 을 목표로 잡으시면 됩니다.",
    " {S} 이 가까워 길이 단순합니다.",
    " 역 기준으로는 {S} 입니다."];
const 층틀 = ["건물에서는 {F} 를 씁니다. 층을 미리 알아 두면 도착해서 헤매지 않습니다.", "{F} 를 쓰고 있습니다. 층수를 알고 가시면 입구에서 바로 찾으실 수 있습니다.", "쓰는 곳은 {F} 입니다. 건물에 들어가기 전에 층을 확인해 두십시오.", "{F} 에 자리하고 있습니다. 층을 기억해 두시면 도착이 수월합니다.", "위치한 층은 {F} 입니다. 미리 알아 두면 입구에서 시간을 아낍니다.", "{F} 입니다. 건물이 커도 층만 알면 찾기 어렵지 않습니다.",
    "{F} 를 씁니다. 층만 알고 계시면 입구에서 멈칫할 일이 없습니다.",
    "건물 안에서는 {F} 입니다. 올라가실 층을 먼저 확인하십시오.",
    "쓰는 층은 {F} 입니다. 미리 알고 가시면 시간이 덜 듭니다.",
    "{F} 에 있습니다. 층수만 기억하시면 됩니다.",
    "자리한 층은 {F} 입니다. 도착해서 헤맬 일이 줄어듭니다.",
    "{F} 입니다. 건물에 들어서면 층 표시부터 보십시오.",
    "층은 {F} 로 확인됩니다. 알고 가시면 입구가 단순해집니다.",
    "{F} 를 쓰고 있어 층을 먼저 챙기시면 좋습니다.",
    "들어가실 층은 {F} 입니다. 한 번만 확인해 두십시오.",
    "위치한 곳은 {F} 입니다. 층을 알면 나머지는 쉽습니다.",
    "{F} 에 자리합니다. 층 표시를 따라가시면 됩니다.",
    "쓰이는 층은 {F} 입니다. 미리 봐 두시면 편합니다.",
    "{F} 입니다. 엘리베이터에서 층만 누르시면 됩니다.",
    "확인된 층은 {F} 입니다. 도착 전에 기억해 두십시오."];
const 시간틀 = ["영업시간은 {H} 입니다. 일찍 가면 자리를 고르기 쉽고, 늦게 가면 홀이 채워진 뒤의 분위기를 보게 됩니다.", "문 여는 시각은 {H} 입니다. 이른 때와 늦은 때가 결이 달라 어느 쪽을 볼지 정하고 가시면 됩니다.", "{H} 에 운영합니다. 초저녁은 한산하고 시간이 갈수록 사람이 찹니다.", "운영 시간은 {H} 입니다. 언제 들어가느냐로 그날 인상이 갈립니다.", "{H} 로 확인됩니다. 도착 시각을 미리 정해 두시면 움직임이 단순해집니다.", "영업은 {H} 입니다. 여유 있게 자리를 잡으시려면 이른 쪽을 권합니다.",
    "{H} 에 문을 엽니다. 언제 들어가시느냐로 결이 달라집니다.",
    "운영은 {H} 로 확인됩니다. 시각을 정해 두시면 움직임이 단순합니다.",
    "{H} 입니다. 이른 때는 여유롭고 늦은 때는 채워집니다.",
    "여는 시간은 {H} 입니다. 자리를 고르시려면 이른 쪽이 낫습니다.",
    "{H} 로 운영합니다. 도착 시각을 미리 잡아 두십시오.",
    "영업 시각은 {H} 입니다. 일행과 시간을 먼저 맞추십시오.",
    "{H} 사이에 가시면 됩니다. 시간대마다 분위기가 다릅니다.",
    "확인된 시간은 {H} 입니다. 언제 갈지부터 정하시면 됩니다.",
    "{H} 입니다. 초저녁과 심야는 같은 곳이라도 다릅니다.",
    "운영 시각 {H} 안에서 편한 때를 고르시면 됩니다.",
    "{H} 로 열립니다. 여유를 두고 오시는 편이 낫습니다.",
    "영업은 {H} 입니다. 마감 시각을 알고 가시면 계획이 섭니다.",
    "{H} 이 기준입니다. 도착 시각만 정하면 나머지는 쉽습니다."];
const 연령틀 = ["출입 기준은 {G} 입니다. 신분증은 꺼내기 좋은 곳에 두시는 편이 편합니다.", "입장 기준은 {G} 입니다. 확인 절차가 있으니 신분증을 챙겨 주십시오.", "{G} 기준으로 받습니다. 신분증은 미리 손 닿는 곳에 두시면 됩니다.", "나이 기준은 {G} 입니다. 일행 모두 해당되는지 미리 확인해 두십시오.", "{G} 입니다. 입구에서 확인이 있으니 신분증을 준비해 주십시오.", "출입은 {G} 로 정해져 있습니다. 신분증 확인이 있습니다.",
    "{G} 로 받습니다. 신분증은 미리 챙겨 두시는 편이 좋습니다.",
    "기준은 {G} 입니다. 입구에서 확인 절차가 있습니다.",
    "{G} 이 기준입니다. 일행분들도 함께 확인해 두십시오.",
    "출입 조건은 {G} 입니다. 신분증을 꺼내기 쉬운 곳에 두십시오.",
    "{G} 만 들어오실 수 있습니다. 확인이 있으니 챙겨 주십시오.",
    "입장 기준이 {G} 이라 신분증이 필요합니다.",
    "{G} 기준으로 운영합니다. 미리 준비해 두시면 빠릅니다.",
    "나이 기준은 {G} 입니다. 확인은 입구에서 이뤄집니다.",
    "{G} 입니다. 일행 모두 해당되는지 먼저 보십시오.",
    "받는 기준은 {G} 입니다. 신분증 없이는 어렵습니다.",
    "{G} 로 정해져 있어 확인 절차를 거칩니다.",
    "출입은 {G} 기준입니다. 미리 챙기시면 기다림이 없습니다.",
    "{G} 이 조건입니다. 신분증을 준비해 주십시오.",
    "기준 연령은 {G} 입니다. 확인이 끝나면 바로 들어가십니다."];
const 문의틀 = ["문의는 아래에 적힌 창구 한 곳으로만 받습니다. 예약이나 자리 요청은 미리 말씀해 두시면 그날 움직이기 수월합니다.", "연락은 아래 창구 하나로만 받고 있습니다. 자리나 인원 이야기는 미리 해 두시는 편이 좋습니다.", "물어보실 곳은 아래 한 곳입니다. 예약 관련한 것은 미리 전해 두시면 준비가 됩니다.", "아래 창구로만 연락을 받습니다. 인원과 시각을 함께 말씀해 주시면 빠릅니다.", "문의 창구는 아래 한 곳뿐입니다. 요청 사항은 미리 남겨 두시는 편이 낫습니다.", "연락처는 아래에 있습니다. 자리 요청은 가시기 전에 말씀해 두십시오.", "물어보실 창구는 아래 하나입니다. 자리 이야기는 미리 해 두시면 수월합니다.", "연락은 아래 한 곳으로 받습니다. 인원과 도착 시각을 함께 알려 주십시오.", "아래 적힌 곳으로만 연락을 받고 있습니다. 요청은 미리 남겨 주십시오.", "문의하실 곳은 아래에 있습니다. 자리 관련한 것은 먼저 말씀해 주십시오.", "연락 창구는 아래 한 군데입니다. 예약 이야기는 미리 전해 두시면 좋습니다.", "아래 번호 한 곳에서만 문의를 받습니다. 시각과 인원을 함께 주십시오.", "문의는 아래 창구로 부탁드립니다. 자리 요청은 미리 알려 주시면 됩니다.", "연락은 여기 적힌 한 곳입니다. 요청 사항은 가시기 전에 남겨 주십시오.", "아래 한 곳이 문의 창구입니다. 인원이 정해지면 먼저 알려 주십시오.", "물어보실 것은 아래로 연락 주십시오. 자리는 미리 말씀해 두시면 편합니다.", "연락 받는 곳은 아래 하나뿐입니다. 예약 관련은 미리 전해 주십시오.", "문의 창구를 아래에 적었습니다. 요청은 먼저 남겨 두시는 편이 좋습니다.", "아래로 연락 주시면 됩니다. 자리와 시각을 함께 말씀해 주십시오.", "연락처는 아래 한 곳입니다. 미리 말씀해 두시면 그날 수월합니다."];
...
/* ★★ 2026-09-03 — 해시 마무리 섞기(avalanche).
     ...
     여는말·문의 둘 다 같은 칸을 뽑아, 같은 가게의 두 쪽이 문장을 공유했다(3그램 27.7%).
     끝에 비트를 섞어 주면 흩어진다. */
function 섞기(x: number): number {
...
function 읽기전정리(v: AdVenue, 씨: string) {
  ...
  const 여는말 = ["아래는 공개된 자료에서 교차 확인한 내용만 추린 것입니다.",
    ...
    "아래에 적은 값은 서로 다른 자료에서 같게 나온 것만 골랐습니다.",
    "확인이 끝난 항목만 아래에 옮겼습니다.",
    "자료 두 곳 이상에서 맞아떨어진 것만 남겼습니다.",
    "아래는 대조를 마친 항목입니다.",
    "확인하지 못한 값은 아예 빼고 적었습니다.",
    "여기 있는 것은 근거를 찾은 항목뿐입니다.",
    "공개 자료를 맞춰 보고 남은 것을 아래에 적습니다.",
    "확인된 만큼만 아래에 정리해 두었습니다.",
    "서로 어긋나는 값은 넣지 않았습니다.",
    "아래 항목은 근거가 있는 것만 추렸습니다.",
    "확인 절차를 거친 값만 아래에 옮겨 적었습니다.",
    "맞춰 본 결과 남은 항목을 아래에 둡니다.",
    "근거를 찾지 못한 값은 비워 두었습니다.",
    "아래 내용은 확인을 마친 범위입니다."];
  const 닫는말 = ["운영 사정에 따라 달라질 수 있으니 방문 전에 한 번 더 확인해 주십시오.",
    ...
    "그날 사정으로 달라질 수 있어 출발 전에 한 번 보시길 권합니다.",
    "값이 달라지는 경우가 있으니 미리 확인해 두시면 좋습니다.",
    "현장에서 바뀔 수 있어 가시기 전에 확인을 권해 드립니다.",
    "사정이 생기면 달라질 수 있습니다. 미리 한 번 봐 주십시오.",
    "바뀌는 일이 있어 방문 전에 확인하시는 편이 안전합니다.",
    "달라질 수 있는 값이라 출발 전 확인을 권합니다.",
    "그때그때 다를 수 있으니 미리 확인해 주시기 바랍니다.",
    "운영 상황에 따라 바뀌므로 가시기 전에 보시면 좋습니다.",
    "확정된 값이 아니라 미리 확인하시는 편이 낫습니다.",
    "사정에 따라 조정될 수 있어 방문 전 확인을 권해 드립니다.",
    "바뀔 여지가 있으니 출발하시기 전에 한 번 더 보십시오.",
    "그날 상황으로 달라질 수 있습니다. 미리 확인을 권합니다.",
    "값이 고정된 것은 아니라 방문 전 확인이 필요합니다.",
    "달라지는 경우가 있어 가시기 전 확인을 부탁드립니다."];
  ...
  /* ★★ 2026-09-03 — 기본값 n=6 이 창고 크기와 따로 놀았다.
  ...
  if (주소) {
    줄.push(주소틀[칸("주소", 주소틀.length)].replace("{A}", 주소) + (역 ? 역틀[칸("역", 역틀.length)].replace("{S}", 역) : ""));
  }

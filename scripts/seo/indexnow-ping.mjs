...
const FALLBACK_ROUTES = [
  ...
  "/hall/ansan-hit",
  "/hall/daejeon-seven",
  "/hall/ilsan-shampoo-hall",
  "/hall/cheongdam",
  "/hall/daejeon-one",
  "/hall/changwon-lululala",
  "/hall/bulgwang-hobak",
  "/hall/ulsan-champion-hall",
  "/hall/doksan-gukbingwan-hall",
  "/hall/dapsimni-miracle",
  "/hall/gangseo-hobak-hall",
  "/hall/yeongdeungpo-terminal-hall",
  "/hall/nowon-hobak-hall",
  "/hall/gildong-chance-hall",
  "/hall/paju-yadang-skydome-hall",
  "/hall/guri-hobak-hall",
  "/hall/uijeongbu-hangukgwan-hall",
  "/hall/uijeongbu-baekakgwan-hall",
  "/hall-guide/suwon-korea-guide",
  "/hall/osan-hobak-hall",
  "/hall/indeogwon-gukbingwan-hall",
  "/hall-guide/seongnam-shampoo-guide",
  "/hall/incheon-arabian-hall",
  "/hall/bucheon-gorae",
  "/hall/pyeongtaek-hobak",
  "/hall/cheonan-stardome-hall",
  "/hall/cheonan-korea",
  "/hall/cheongju-hobak",
  "/hall/ulsan-newworld-hall",
  "/hall-guide/seosan-hobak",
  "/hall/daegu-hobak",
  "/hall/gumi-hobak-hall",
  "/hall/gwangju-sangmu",

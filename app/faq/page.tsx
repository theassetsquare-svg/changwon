...
const FAQ = [
  {
    q: "창원 룰루랄라 나이트 전화번호는?",
    a: ". 매니저 짱구가 직접 받습니다. 다른 직원이 받아 콜백하는 방식이 아닙니다.",
  },
  {
    q: "창원룰루랄라나이트 예약은 어떻게 하나요?",
    a: "로 전화한 뒤 ‘짱구 매니저 부탁드립니다’라고 말하고 인원·날짜·시간만 알려주시면 30초 안에 자리가 확정됩니다. 별도 앱·회원가입은 없습니다.",
  },
  {
    q: "예약 어떻게 해요?",
    a: " 누르고 ‘짱구 매니저요’ 한마디 하시면 됩니다. 인원·날짜·시간 알려주시면 그 자리에서 잡힙니다.",
  },
  {
  ...
  },
  {
    ...
    a: "옵션·인원·시간대에 따라 다릅니다. 그래서 표보다 전화가 정확해요. 로 전화하시면 그 자리에서 인원에 맞는 가격 두세 개 묶어서 알려드립니다.",
  },
  {
    q: "신용카드 / 현금 어떻게 결제해요?",
  ...
  {
    q: "주차할 수 있나요?",
    a: "위치 따라 다릅니다. 인근 주차 안내 필요하시면 로 전화 주세요. 도착 직전에도 괜찮습니다.",
  },
  {
    q: "예약 취소하면 페널티 있어요?",
  ...
  {
    q: "당일 예약도 가능한가요?",
    a: "가능합니다. 도착 직전이라도 로 전화 주시면 자리가 있을 경우 바로 잡아드립니다.",
  },
  {
    q: "단체로 가도 돼요?",
  ...
  {
    q: "VIP 룸 따로 있나요?",
    a: "운영 시점에 따라 다릅니다. 로 ‘VIP 룸 가능한지’ 한마디 물어보시면 그 시점 상황을 짱구 매니저가 답해드립니다.",
  },
  {
    q: "오늘 영업하나요?",

...
const PRICE_FAQ = [
  {
    ...
    a: "옵션·인원·시간대에 따라 다릅니다. 평균치는 의미가 적기 때문에 로 짱구 매니저가 인원에 맞는 두세 가지 옵션의 정확한 금액을 묶어 안내합니다.",
  },
  {
  ...
  {
    q: "결제는 카드 / 현금 다 되나요?",
    a: "결제 수단 세부 정책은 변동될 수 있어 사이트 표기보다 전화로 확인이 정확합니다. 로 미리 문의 주시면 그 자리에서 안내합니다.",
  },
];

...
export const metadata: Metadata = {
  ...
  openGraph: {
    url: "/reserve",   /* og:url — canonical 과 같게 (네이버 오픈그래프 필수) */
    title: m.title,
    description: m.description,
    images: THUMB.images,
  },
...
const RESERVE_FAQ = [
  ...
  {
    q: "온라인 예약 페이지는 없나요?",
    a: "없습니다. 별도 앱·회원가입·결제 사전등록도 없습니다. 전화 010-7528-4936로 한 번에 예약됩니다.",
  },
  {
    q: "당일 예약도 되나요?",
  ...
  return (
    <PageShell title="창원룰루랄라나이트 예약" hook={m.hook} pathname="/reserve" thumbAlt={THUMB.alt}>
      ...
      <ol className="space-y-3 rounded-2xl border border-line bg-elev p-5 text-gray-200">
        ...
        <li id="step4">
          <strong className="text-gold">4.</strong> 신분증 챙겨서 도착.
        </li>
      </ol>

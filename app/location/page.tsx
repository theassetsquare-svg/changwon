...
const LOC_FAQ = [
  {
    q: "창원 룰루랄라 나이트 정확한 주소가 어디인가요?",
    a: "경상남도 창원시 안에 위치합니다. 매장 확정 시점에 상세 번지를 본 페이지와 네이버 플레이스에 반영합니다. 현재는 도착 시 010-3854-6887로 전화하면 짱구 매니저가 입구를 잡아드립니다.",
  },
  {
    q: "주차 가능한가요?",
  ...
  },
  {
    ...
    a: "가장 가까운 버스/지하철 정거장 안내는 도착 시점이 가장 정확합니다. 택시로 오시면 기사님께 ‘창원 룰루랄라 나이트’ 또는 매장 주소를 말씀하시면 됩니다.",
  },
  {
  ...
  return (
    ...
    >
      <p>
        ...
        {SITE.region} {SITE.city} 안에 위치합니다.
      </p>
      ...
      <p className="text-gray-300">
        ...
        잡으시면 기사님께 “창원 룰루랄라 나이트” 또는 위 주소 말씀하시면 됩니다.

...
const LOC_FAQ = [
  {
    q: "정확한 주소가 어디인가요?",
    a: "경상남도 창원시 성산구 상남동 22-4 지하 3층(모아엔트몰)입니다. 도로명은 마디미로43번길 10. 도착 시 010-3854-6887로 전화 주시면 매니저가 입구를 잡아드립니다.",
  },
  {
    q: "주차 가능한가요?",
    a: "매장 인근 주차 안내는 매장 측에서 직접 안내합니다. 자리 안 보이시면 전화 010-3854-6887로 연락 주세요. 위치를 잡아드립니다.",
  },
  {

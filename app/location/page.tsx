...
const LOC_FAQ = [
  {
    q: "정확한 주소가 어디인가요?",
    a: "경상남도 창원시 성산구 상남동 22-4 지하 3층(모아엔트몰)입니다. 도로명은 마디미로43번길 10. 도착 시 카카오톡 besta12로 연락 주시면 매니저가 입구를 잡아드립니다.",
  },
  {
    q: "주차 가능한가요?",
    a: "매장 인근 주차 안내는 매장 측에서 직접 안내합니다. 자리 안 보이시면 카카오톡 besta12로 연락 주세요. 위치를 잡아드립니다.",
  },
  {
  ...
  },
  {
    ...
    a: "가능합니다. 매장에서 대리·택시 잡아드립니다. 음주 후 운전은 안 됩니다. 카카오톡이나 매장에서 한마디 해 주시면 됩니다.",
  },
];
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-300">
        ...
        반영합니다. 그 전까지는 도착 시 카카오톡 주시면 입구까지 안내합니다.
      </p>
      ...
      <p className="text-gray-300">
        ...
        보이시면 카카오톡 주세요. 위치 잡아드립니다. 주차 만석일 때 인근 유료 주차장
        대안도 함께 안내합니다.
      </p>
      ...
      <ul className="space-y-2 text-gray-300">
        ...
        <li>경상남도 외 지역 — 미리 카카오톡 주시면 도착 시간 맞춰 자리 잡아둠</li>
      </ul>

      <h2 className="pt-2 text-xl font-bold text-white">끝나고 이동</h2>
      <p>
        대리·택시 필요하시면 가게에서 잡아드립니다. 카카오톡으로 미리 알려주시거나,
        매장에서 한마디 해 주세요 —{" "}

...
const JJANGGU_FAQ = [
  {
    ...
    a: "네, 로 오시는 전화 거의 다 매니저 짱구가 직접 받습니다. 영업 손님 응대 중일 때만 잠시 늦을 수 있고, 그 외에는 직원 거치지 않고 바로 응대합니다.",
  },
  {
    q: "짱구 매니저는 어떤 사람이에요?",
  ...
  },
  {
    ...
    a: "본 매장의 직통 응대 매니저는 짱구 한 명입니다. 다른 직원이 ‘짱구 대신 받았다’고 하면 같은 매장 아닐 가능성이 있으니,  번호 그대로 다시 걸어 확인해 주세요.",
  },
];

...
const NEWS_FAQ = [
  {
    ...
    a: "정규 영업 중일 가능성이 큽니다. 다만 가장 정확한 답은 010-3854-6887로 전화하는 것입니다. 임시 휴무가 있을 경우 본 페이지에 사전 안내됩니다.",
  },
  {
    q: "휴무 공지는 언제 올라오나요?",
  ...
  {
    q: "공지 알림을 받을 방법이 있나요?",
    a: "본 사이트 RSS 피드(/feed.xml)를 구독하시거나, 010-3854-6887로 미리 연락 주시면 영업 변경 시 안내드립니다.",
  },
];

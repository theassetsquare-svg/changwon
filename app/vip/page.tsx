...
export const metadata: Metadata = {
  ...
  openGraph: {
    url: "/vip",   /* og:url — canonical 과 같게 (네이버 오픈그래프 필수) */
    title: m.title,
    description: m.description,
    images: THUMB.images,
  },
...
const VIP_FAQ = [
  {
    ...
    a: "일반 예약과 동일합니다. 전화 010-7528-4936로 'VIP 룸으로 잡아주세요' 한마디 하시면 됩니다. 그 시점 룸 상황을 보고 가능한 시간대를 안내합니다.",
  },
  {
    q: "VIP 룸 가격이 따로 있나요?",
  ...
  {
    q: "VIP 룸은 별도 입구가 있나요?",
    a: "별도 동선 운영 여부는 시점에 따라 다릅니다. 예약 확정 시 매니저가 도착 동선을 함께 안내합니다.",
  },
  {
    q: "VIP 룸 최소 인원이 있나요?",

...
const HOME_FAQ = [
  {
    q: "창원 룰루랄라 나이트 전화번호는?",
    a: "010-3854-6887. 매니저 짱구가 직접 받습니다. 직원이 받아 콜백하는 방식이 아닙니다.",
  },
  {
    q: "창원룰루랄라나이트 예약은 어떻게 하나요?",
    a: "010-3854-6887로 전화해 ‘짱구 매니저 부탁드립니다’라고 말한 뒤 인원·날짜·시간을 알려주시면 30초 안에 자리가 잡힙니다. 앱·회원가입 없습니다.",
  },
  {
  ...
  {
    q: "창원 룰루랄라 가격은 얼마인가요?",
    a: "옵션·인원·시간대에 따라 다릅니다. 010-3854-6887로 전화하면 인원에 맞는 옵션 두세 개의 정확한 금액을 그 자리에서 묶어 안내합니다.",
  },
  {
    q: "창원 룰루랄라 위치는 어디인가요?",
    ...
    <main>
      ...
      <section className="mx-auto max-w-3xl px-4 py-10">
        ...
        <div className="mt-4 space-y-4 text-gray-300">
          ...
          <p>
            저장해 두시면 다음에 편합니다. 010-3854-6887. 창원 룰루랄라 짱구.
            이 두 줄이면 충분합니다.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-4 py-12">
        <div className="rounded-2xl border border-line bg-elev p-6 text-center">
          ...
          <p className="mt-2 text-xs text-gray-500">
            창원 룰루랄라 나이트 · 매니저 짱구 · 010-3854-6887
          </p>
